...
// Name : game_actions.parse_event(event)
// Desc : parses an event into readable html
// Author(s) : RAk3rman
exports.parse_event = async function (event) {
    if (event.tag === "create-player") {
        return {
            ...
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> joined the lobby",
        ...
        return {
            ...
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> started the game",
            created: moment(event.created).format()
        };
        ...
        return {
            ...
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> reset the game",
            created: moment(event.created).format()
        };
        ...
        if (event.rel_id === "attack") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> played an attack card";
            ...
            return {
                ...
                desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> exploded",
                created: moment(event.created).format()
            };
        } else if (event.rel_id === "defuse") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> played a defuse card";
            ...
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> asked for a favor from <strong class=\"text-gray-700\">" + event.target_plyr_id + "</strong>";
        } else if (event.rel_id === "reverse") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> played a reverse card";
        } else if (event.rel_id === "seethefuture") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> saw the future";
        } else if (event.rel_id === "shuffle") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> shuffled the deck";
        } else if (event.rel_id === "skip") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> skipped their turn";
        } else if (event.rel_id === "hotpotato") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> used a hot potato";
        } else if (event.rel_id === "scrambledeggs") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> scrambled all hands in play";
        } else if (event.rel_id === "superskip") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> used a super skip";
        } else if (event.rel_id === "safetydraw") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> played a safety draw card";
        } else if (event.rel_id === "drawbottom") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> drew from the bottom";
        } else if (event.rel_id === "favorgator") {
            desc = "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> used a favor gator on <strong class=\"text-gray-700\">" + event.target_plyr_id + "</strong>";
        }
        return {
        ...
        return {
            ...
            icon_color: "text-green-500",
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> drew a new card",
            created: moment(event.created).format()
        };
        ...
        return {
            ...
            icon_color: "text-red-500",
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> kicked <strong class=\"text-gray-700\">" + event.target_plyr_id + "</strong> from the game",
            created: moment(event.created).format()
        };
        ...
        return {
            ...
            icon_color: "text-purple-500",
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> made <strong class=\"text-gray-700\">" + event.target_plyr_id + "</strong> the host",
            created: moment(event.created).format()
        };
        ...
        return {
            ...
            icon_color: "text-green-500",
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> added the <strong class=\"text-gray-700\">" + pack + "</strong> card pack",
            created: moment(event.created).format()
        };
        ...
        return {
            ...
            icon_color: "text-red-500",
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> removed the <strong class=\"text-gray-700\">" + pack + "</strong> card pack",
            created: moment(event.created).format()
        };
        ...
        return {
            ...
            icon_color: "text-yellow-400",
            desc: "<strong class=\"text-gray-700\">" + event.req_plyr_id + "</strong> won the game",
            created: moment(event.created).format()
        };
    } else {
        return {
